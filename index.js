...
const UUID = process.env.UUID || 'a79802e5-b9b0-48e8-8022-f92dc570f68c'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'gCNZBwoZ9WigfrzOzvgtNySHOfN78DPi';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'web.alpha.us.kg';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
...
const PORT = process.env.PORT || 25235;                     // http和ws服务端口
